...
Reference Cinema 4D scene showing a correctly configured Redshift **Depth AOV** for use with depth-based compositing tools (e.g. [Depth Range Slice](../../After%20Effects%20Scripts/Depth%20Range%20Slice/)).
